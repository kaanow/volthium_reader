...
| Ref | Part | Pkg | Qty | DigiKey SKU | Mouser SKU | Price | Notes |
|-----|------|-----|-----|-------------|------------|-------|-------|
| J-USB | **USB-C receptacle GCT USB4085-GF-A** (native ESP32-S3 USB, board edge) | THT top-mount (F13) | 1 | 2073-USB4085-GF-ATR-ND (102k stock, Active; API 2026-07-27 — order the cut-tape listing at qty 1) | 640-USB4085-GF-A (84k) | $0.85 | **Δ (D27): bench/recovery port** — reached by popping the faceplate (no front cutout); routine updates OTA over RS-485. Replaces the USB-OTG pin header. Same SKU as battery J3 → one footprint + one reel across boards |
