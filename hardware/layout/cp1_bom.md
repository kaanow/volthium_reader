...
| U4  | **TI TPS389030DSER** voltage supervisor (~2.1 µA, SENSE, OD RESET, CT delay) | **6-WSON 1.5×1.5 mm (leadless ⚠)** | 1 | 296-51976-2-ND | 595-TPS389030DSER | $0.80 | **NEW (D28/DR-16):** hardware UVLO backstop. **Variant chosen for stock (API 2026-06-25): TPS389030DSER** (Mouser ~2.7k / DK ~2.5k); the earlier-implied **TPS389001 is DK 0-stock**. **SENSE threshold datasheet-confirmed 2026-06-26: VITN = 2.89 V** (TPS389030); divider R1≈1.69 MΩ/R2≈287 kΩ + R_hys≈3.9 MΩ → trip ~19.9 V / release ~21.3 V (see R_uv/R_hys rows). Datasheet: hardware/datasheets/TPS389030DSER.pdf |
| R_uv1 (top), R_uv2 (bottom) | UVLO pack divider → U4 SENSE. **VITN = 2.89 V** (TPS389030, datasheet 2026-06-26): **R1 ≈ 1.69 MΩ, R2 ≈ 287 kΩ** (E96; trip ≈ 19.9 V) | 0805 ×2 | 2 | _verify_ | _verify_ | $0.10 ea | **NEW (D28); R_total ≈ 2.0 MΩ not 10 MΩ (F02)** — SENSE current ~100 nA max → ≥10 µA divider; 20 V/1.98 MΩ = 10.1 µA at trip ✓ |
| R_hys | UVLO external hysteresis, U4 RESET → SENSE | 0805 | 1 | _verify_ | _verify_ | $0.05 | **~3.9 MΩ (F01)** → ~1.4 V band (built-in is only 0.325 % ≈ 65 mV). ΔV_trip ≈ 3.3 V × R1/R_hys |
