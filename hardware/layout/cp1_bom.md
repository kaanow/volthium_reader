...
| J3  | **USB-C receptacle GCT USB4085-GF-A** (native ESP32-S3 USB) | SMD | 1 | 2073-USB4085-GF-ATR-ND (102k stock, Active; API 2026-07-27 — order the cut-tape listing at qty 1) | 640-USB4085-GF-A (84k) | $0.85 | **Δ (D22): was a USB-OTG pin header** — now a board-edge maintenance port (flash/console/JTAG), accessible without opening. ESD-protected by U-ESD. MPN now pinned (was _verify_); matches the schematic's GCT USB4085 footprint and the display J-USB |
...
| Ref | Part | Pkg | Qty | DigiKey SKU | Mouser SKU | Price | Notes |
|-----|------|-----|-----|-------------|------------|-------|-------|
| J-USB | **USB-C receptacle GCT USB4085-GF-A** (native ESP32-S3 USB, board edge) | SMD | 1 | 2073-USB4085-GF-ATR-ND (102k stock, Active; API 2026-07-27 — order the cut-tape listing at qty 1) | 640-USB4085-GF-A (84k) | $0.85 | **Δ (D27): bench/recovery port** — reached by popping the faceplate (no front cutout); routine updates OTA over RS-485. Replaces the USB-OTG pin header. Same SKU as battery J3 → one footprint + one reel across boards |
