...
| J-USB | **USB-C receptacle GCT USB4115-03-C** — **VERTICAL**, on native ESP32-S3 USB (front face, D40) | THT top-mount (F13) | 1 | **D27:** bench/recovery port — reached by popping the faceplate (no front cutout). Routine firmware is OTA over RS-485, so it's rarely used. *(CP2: pinned to the same GCT SKU as the battery board's J3; API-verified in stock 2026-07-27)* |
