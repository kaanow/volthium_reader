...
| CRCW1206150RFKEAHP | Vishay_CRCW_HP.pdf (150K, doc 20043 rev 17-Mar-2026) | vishay (API proxy 2026-07-18) | https://www.vishay.com/docs/20043/crcwhpe3.pdf — **Pulse-Proof, High Power** thick-film chip R. p.1: 1206-HP rated **0.75 W (P70) / 1.5 W**, Umax 200 V. p.8 §8.1 short-term-overload = 2.5·√(P·R) for 5 s (→ 9.4 W/5 s at P=1.5 W, R=150 Ω). p.5 single-pulse curve. **R_inrush 150 Ω, F84.** | bdd4e4b9b924 |
| 0451.062MRL | Littelfuse_451_453.pdf (480K, rev 12/01/25) | littelfuse (API proxy 2026-07-18) | https://www.littelfuse.com/assetdocs/littelfuse-fuse-451-453-datasheet — 451/453 Nano2® SMF **Very-Fast-Acting** fuse. p.1: 200%→**5 s max** opening. p.2 (.062 row): **125 V**, **50 A @125 VDC** interrupt, Rcold 5.5 Ω, **nominal melting I²t 1.9e-4 A²s**. **F2 switched-branch fault clear, F84.** | 399d3cc9da99 |
