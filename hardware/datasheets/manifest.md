...
| SI2309CDS-T1-GE3 | SI2309CDS_Vishay.pdf | digikey via API proxy 2026-07-17 | https://www.vishay.com/docs/68980/si2309cd.pdf — **Q1 load switch (F57 replacement: ZXMP6A13FTA went NRND)**: −60 V, ID −1.6 A; RDS(on) max 0.345 Ω @ VGS=−10 V / 0.450 Ω @ −4.5 V; VGS ±20 V (DZ1 12 V clamp scheme unchanged); VGS(th) −1…−3 V; **IDSS ≤100 nA @25 °C, ≤1 µA @TJ=55 °C** (specified elevated-temp row) | feb0974dd371 |
| DMG3415U-7 | DMG3415U_Diodes.pdf (DS31735 Rev 14-3) | digikey via API proxy 2026-07-17 | https://www.diodes.com/datasheet/download/DMG3415U.pdf — **3V3-domain switches ×3 (2× channel + Q_exp; F56/F57)**: −20 V, −4 A; **RDS(on) max 42.5 mΩ @ −4.5 V / 53 mΩ @ −2.5 V / 71 mΩ @ −1.8 V** (the −2.5 V guaranteed row qualifies the direct 3.3 V GPIO drive); VGSS ±8 V; VGS(th) −0.3…−1.0 V; IDSS ≤1 µA @ −20 V/25 °C | 3863b974014c |
