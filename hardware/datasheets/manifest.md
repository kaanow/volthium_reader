...
| MMBT5551LT1G | MMBT5551_onsemi.pdf (MMBT5550/5551, Rev, May 2023) | digikey via API proxy 2026-07-17 | https://www.onsemi.com/pdf/datasheet/mmbt5550lt1-d.pdf — **Q1 gate-driver NPN BJT (F68 replacement: 2N7002 had no guaranteed on-state at the 3.3 V drive)**: **VCEO 160 V**; hFE ≥60 @1 mA; **VCE(sat) ≤0.15 V @10 mA/1 mA / 0.20 V @50 mA/5 mA** (MMBT5551; the 0.25 V is the MMBT5550); **ICBO ≤50 nA @25 °C / ≤50 µA @ VCB=120 V, TA=100 °C** (guaranteed hot cutoff; F72 — unit column flips nA→µA); ICES (BE-shorted) 50/100 nA @25 °C only. Used with R_be bleeder so leakage isn't amplified: Vgs_off = ICBO·R3 ≤0.34 V @100 °C. onsemi, DK 689k Active | 3ae47cf6f802 |
