...
| AQY212EH | AQY212EH_Panasonic.pdf (Panasonic GE DIP4 1-Form-A catalog, doc ASCTB126E, 2026.1) | **user upload 2026-07-18 (manufacturer-direct — replaced the octopart mirror; Panasonic host WAF-blocks the proxy)** | Panasonic Industry GE DIP4 1 Form A | — **Display-feed load switch SSR (F76)**: 1-Form-A, **load 60 V / 550 mA**, 5000 Vrms I/O isolation, Ron **0.85 Ω typ / 2.5 Ω max** (AQY212EH row, corrected iter-50 F79 — 0.25 Ω was the AQY211EH sibling), **off-state leakage ≤1 µA @ 25 °C** (rises but non-amplifying to +85 °C), LED operate 1.2 mA typ / 3 mA max / turn-off min 0.4 mA, peak load 1.5 A/100 ms one-shot, rated −40…+85 °C. **AQY212EH = through-hole DIP4** (AQY212EHA is the SMD variant). DK 255-2963-ND / Mouser 769-AQY212EH, Active | d329b9729322 |
