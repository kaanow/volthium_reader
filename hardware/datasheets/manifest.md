...
| AQY212EH | AQY212EH_Panasonic.pdf (Panasonic GE DIP4 1-Form-A catalog, doc ASCTB126E, 2026.1) | **user upload 2026-07-18 (manufacturer-direct — replaced the octopart mirror; Panasonic host WAF-blocks the proxy)** | Panasonic Industry GE DIP4 1 Form A | — **Display-feed load switch SSR (F76)**: 1-Form-A, **load 60 V / 550 mA**, 5000 Vrms I/O isolation, Ron 0.25 Ω typ, **off-state leakage ≤1 µA (max, headline feature p.1)**, LED operate 1.2 mA typ / turn-off min 0.4 mA, rated −40…+85 °C. **AQY212EH = through-hole DIP4** (AQY212EHA is the SMD variant). DK 255-2963-ND / Mouser 769-AQY212EH, Active | d329b9729322 |
