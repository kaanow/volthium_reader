...
| 53398-0871 | Molex_53398-0871_PicoBlade_vert.pdf | molex (API proxy) | https://www.molex.com/pdm_docs/sd/533980871_sd.pdf — PicoBlade 1.25 mm, 8-ckt, SMT vertical, tin. **The drawing carries no current rating (F49)** — rating comes from the mate-side product spec PS-51021-009 (delta table below): 1.0 A max @ AWG 26–28. R/A alt 53261-0871 (Molex_53261-0871_PicoBlade_RA.pdf, sha 6e1b0968c9ed) | 642bc09ea605 |
...
| 51021 mate system (housing 51021-0800 + terminal 50079-8\*00) | Molex_PS-51021-009_PicoBlade_product_spec.pdf (393K) | digikey via API proxy 2026-07-16 | https://www.molex.com/pdm_docs/ps/PS-51021-009.pdf | 1213f6f54215 | **PRODUCT SPECIFICATION** (F49 — not a drawing): scope table covers receptacle housing 51021-\*\*00 + female terminal 50079-8\*00 (AWG 26–28); §3 ratings **1.0 A max (AWG 26/28/30), 0.8 A (AWG 32), 125 V AC rms/DC, −40…+85 °C**, temp-rise ≤30 °C @ rated current, contact R ≤40 mΩ (init. ≤20 mΩ). Header-side spec **PS-51021-024 still off-file — requested from owner**. Qty-1 mating hardware = OTS cable assembly 0151340801 (see cp1_bom.md J_EXP row) |
