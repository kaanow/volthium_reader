...
| **CAN pinout — battery-side connector, NOT RJ45** | *"On our CAN, the first pine is CAN High and the 2nd is CAN Low"* (**2023-11-14**); *"our CAN uses pin 1 and 2"* (**2023-11-21**). **Domain resolved by the thread context:** the owner's question (2023-12-27) was explicitly about the **connector on the battery** — *"It is not the RJ45 I expected … it is not clear which pins are 1 and 2"*. So CAN-H/L = **pins 1/2 of the pack's 4-pin connector**. The **in-service cable** (2026-07-17 beep-out) maps those to **RJ45 4/6** (see the measured-map row below). The photographed Pro-Series *label* prints CAN on RJ45 **4/5** — a **different cable product**, not the in-service cable; the two maps are **not** the same (F63 — do not call them consistent). | **RESOLVED** — battery-side domain; in-service map measured |
