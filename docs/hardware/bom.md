...
> for WiFi — D25), U2 (R-78E12→R-78HB12), Q1 (AO3401A then ZXMP6A13F, superseded by **Si2309CDS**, iter-38 F57), Q2
> (AO3400A→2N7002→**MMBT5551** BJT, F68/F72), D1 (SS24→SS26), input bulk caps →100 V, sense divider
...
| Ref       | Part                                            | Pkg     | Qty | Proto / PCB | DigiKey | Mouser | Price  | Notes |
|-----------|-------------------------------------------------|---------|-----|-------------|---------|--------|--------|-------|
| Q1        | **Vishay Si2309CDS** P-MOSFET (Vds −60 V, −1.6 A) | SOT-23  | 1   | PCB         | [search Si2309CDS](https://www.digikey.com/en/products/result?keywords=SI2309CDS-T1-GE3) | [Mouser](https://www.mouser.com/c/?q=SI2309CDS) | $1.39  | Load switch for the 12 V/display feed (~0.3 A). 60 V out-rates the ~53 V clamp (D19/DR-4). Was AO3401A (30 V) → ZXMP6A13F, replaced iter-38 (**F57: ZXMP went NRND**). DK 120k stock, Active (API 2026-07-17). |
| Q2        | **MMBT5551** NPN BJT (Vceo 160 V)              | SOT-23  | 1   | PCB         | [search MMBT5551](https://www.digikey.com/en/products/result?keywords=MMBT5551LT1G) | [Mouser](https://www.mouser.com/c/?q=MMBT5551) | $0.24  | Drives Q1's gate from 3.3 V. **BJT (F68/F72):** guaranteed ON via saturation, OFF via bounded ICBO (2N7002 had no guaranteed 3.3 V on-state). +R_base/R_be 10 kΩ. Was AO3400A → 2N7002. |
| DZ1       | **BZX84C12** 12 V Zener (Q1 gate–source clamp)  | SOT-23  | 1   | PCB         | [search BZX84C12](https://www.digikey.com/en/products/result?keywords=BZX84C12) | [Mouser](https://www.mouser.com/c/?q=BZX84C12) | $0.10  | Redundant Vgs backstop; the R3/Rg divider is the bracket (Vgs ≤12.4 V at the 53.3 V surge — F64). New part. |
| R3        | **6.8 kΩ** 1 % — Q1 gate pull-up, gate→source (Δ F64→F72: 100 kΩ→10 kΩ→6.8 kΩ) | 0805 | 1 | PCB | [search](https://www.digikey.com/en/products/result?keywords=10k+0805+1%25) | [search](https://www.mouser.com/c/?q=10k%200805%201%25) | $0.10 | Default-OFF load switch |
| R4        | 100 kΩ 1 % — PWR_EN pull-down (brown-out failsafe-off) | 0805 | 1 | PCB | [search](https://www.digikey.com/en/products/result?keywords=100k+0805+1%25) | [search](https://www.mouser.com/c/?q=100k%200805%201%25) | $0.10 | Brown-out failsafe-off. The **22 kΩ** series gate resistor Rg (Δ F64→F72: was ~1 kΩ) sits between Q2 collector and Q1 gate; the R3/Rg divider is the Vgs bracket, DZ1 a backstop. |
