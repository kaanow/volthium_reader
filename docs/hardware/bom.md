...
| U6        | **TI TPS2116** priority power mux (~1.3 µA Iq, 2.5 A, reverse-blocking) | SOT-23-6 | 1 | PCB | [search TPS2116](https://www.digikey.com/en/products/result?keywords=TPS2116) | [Mouser](https://www.mouser.com/c/?q=TPS2116) | $0.70 | **D29.** VIN1=USB-LDO (priority), VIN2=LM5166 buck, OUT=V3V3 → USB present = buck idles (pack draw ~µA). Only ~1.3 µA always-on. |
...
| U4        | **TI TPS3890** voltage supervisor (~2.1 µA, adj. SENSE, OD RESET, prog. delay) | SOT-23-6 | 1 | PCB | [search TPS3890](https://www.digikey.com/en/products/result?keywords=TPS3890) | [Mouser](https://www.mouser.com/c/?q=TPS3890) | $0.80 | **Hardware UVLO backstop (D28/DR-16).** Asserts ESP EN low below ~20 V pack → MCU to ~µA reset + display auto-sheds (PWR_EN Hi-Z). Backstops a hung-but-powered MCU the firmware-only shed misses. Confirm SKU/threshold at BOM-lock. |
...
| U4-MUX    | **TI TPS2116** priority power mux               | SOT-23-6 | 1   | PCB         | [search TPS2116](https://www.digikey.com/en/products/result?keywords=TPS2116) | [Mouser](https://www.mouser.com/c/?q=TPS2116) | $0.70 | **D29.** VIN1=USB-LDO (priority), VIN2=R-78E3.3, OUT=V3V3. No UVLO bypass (display has no supervisor). |
