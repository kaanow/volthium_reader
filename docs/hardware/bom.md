...
| Q3        | small-signal N-FET (UVLO bypass)               | SOT-23  | 1 | PCB | [search 2N7002](https://www.digikey.com/en/products/result?keywords=2N7002) | [Mouser](https://www.mouser.com/c/?q=2N7002) | $0.10 | **D29.** Opens U4's RESET→EN when VBUS present so the MCU boots off USB on a dead/absent pack (bench). VBUS-referenced. |
