...
| R_hys     | UVLO external hysteresis (RESET→SENSE) | 0805 | 1 | PCB | — | — | $0.05 | **Reviewer iter-5 F01/D33 (~11.5 MΩ).** RESET is active-low → R_hys is positive feedback that pulls the *falling* trip down; sets a ~1.5 V band (trip ~20.0 V / release ~21.5 V). Built-in VHYS (~6 mV at SENSE) too small alone. Pairs with the **release-sized** R1≈5.16 MΩ/R2≈100 kΩ divider. |
...
| R_uv1,R_uv2 | UVLO pack divider → U4 SENSE (release-sized R1≈5.16 MΩ/R2≈100 kΩ; trip ~20.0 V / release ~21.5 V)        | 0805 ×2 | 2 | PCB | [search](https://www.digikey.com/en/products/result?keywords=high+value+0805+resistor) | — | $0.10 | VIT 0.405 V → ~4.6 µA draw at 24 V (D28/D33; F01). |
