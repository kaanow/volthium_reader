...
| BTN1      | **C&K 8125SHZBE** panel-mount (bushing) momentary pushbutton, gold contacts, 0.4 VA @ 20 V logic-level rating (SPDT wired COM–NO) | Panel-mount | 1   | both        | [CKN4022-ND](https://www.digikey.com/en/products/result?keywords=8125SHZBE) | [611-8125-241](https://www.mouser.com/c/?q=8125SHZBE) | $18.47 | On battery-side enclosure; BTN_OVERRIDE on GPIO7 (RTC-wake). **Δ: was EG1218 → RP3502MABLK → 8125SHZBE (iter-23 F22: RP3502 had no dry-circuit rating for our 3.3 V/µA use; 8125+B is explicitly rated).** D-OPEN-13 moot (unsealed accepted, IP5x indoor). Canonical row: cp1_bom.md |
