...
| Ref       | Part                                            | Pkg     | Qty | Proto / PCB | DigiKey | Mouser | Price  | Notes |
|-----------|-------------------------------------------------|---------|-----|-------------|---------|--------|--------|-------|
| U3        | **Renesas ISL3175EIBZ** genuine 3.3 V half-duplex, slew-limited | SOIC-8  | 1   | both        | [DK ISL3175EIBZ-ND](https://www.digikey.com/en/products/detail/renesas-electronics-america-inc/ISL3175EIBZ/2088091) ✓ | [Mouser 968-ISL3175EIBZ](https://www.mouser.com/c/?q=ISL3175EIBZ) | $3.10  | **D34/DR-25 (reviewer iter-8 F05):** the previous SN65HVD3082E was a 5 V part (VCC 4.5–5.5 V) that both boards ran outside spec on V3V3. ISL3175E is a true 3.3 V part (VCC 3.0–3.6 V). Iq 800 µA max / 250 µA typ; **shutdown Iq 10 nA** via DE=0+/RE=1 (see R_DE / R_RE below). Renesas Active, DK+Mouser 3646 stock. |
| R_DE      | 100 kΩ 1 % pull-DOWN: U3 DE → GND               | 0805    | 2   | battery     | PCB         | — | $0.05 | **D34/F06:** defaults DE=0 when GPIO2 Hi-Z. Both boards (battery U3, display U2). |
| R_RE      | 100 kΩ 1 % pull-UP: U3 /RE → V3V3               | 0805    | 2   | battery     | PCB         | — | $0.05 | **D34/F06:** defaults /RE=1 when GPIO15 Hi-Z; together with R_DE puts transceiver in 10 nA shutdown any un-driven moment. Both boards. |
...
| Ref       | Part                                            | Pkg     | Qty | Proto / PCB | DigiKey | Mouser | Price  | Notes |
|-----------|-------------------------------------------------|---------|-----|-------------|---------|--------|--------|-------|
| U2        | **Renesas ISL3175EIBZ** (as battery U3)         | SOIC-8  | 1   | both        | (as battery U3) | (as battery U3) | $3.10  | **D34/DR-25** — see battery-side U3 row. Same part, same footprint, same enable topology (R_DE pull-DOWN + R_RE pull-UP for real shutdown). |
