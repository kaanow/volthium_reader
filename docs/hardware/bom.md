...
| R_hys     | UVLO external hysteresis (RESET→SENSE, ~3.9–4.7 MΩ) | 0805 | 1 | PCB | — | — | $0.05 | **Reviewer F01.** Sets a deliberate ~1.5 V band (trip ~20 V / release ~21.5 V) — the TPS3890's built-in ~0.12 V is too small. Pairs with the ~2.0 MΩ UVLO divider (F02). |
...
| U4        | **TI TPS389030DSER** voltage supervisor (~2.1 µA, SENSE, OD RESET, prog. delay) | **6-WSON 1.5×1.5 (leadless)** | 1 | PCB | [search TPS389030DSER](https://www.digikey.com/en/products/result?keywords=TPS389030DSER) | [Mouser](https://www.mouser.com/c/?q=TPS389030DSER) | $0.80 | **Hardware UVLO backstop (D28/DR-16).** Asserts ESP EN low below ~20 V pack → MCU to ~µA reset + display auto-sheds. **Variant TPS389030DSER (stocked; TPS389001 is DK 0-stock); package WSON 1.5×1.5, leadless (see DR-24).** Size divider to its SENSE threshold at CP2. |
| R_uv1,R_uv2 | UVLO pack divider → U4 SENSE (~10 MΩ-class, ~20 V trip)        | 0805 ×2 | 2 | PCB | [search](https://www.digikey.com/en/products/result?keywords=high+value+0805+resistor) | — | $0.10 | High-value → ~2 µA draw (D28). |
