...
| F2        | **80 mA** very-fast SMD fuse (Littelfuse 451 Nano2 SMF) — switched branch | 1206 | 1 | PCB | F3649TR-ND | 576-0451.080MRL | $4.57 | **NEW (F84); re-picked 62→80 mA iter-54 (F87).** Coordinated fault clear: worst-case short 0.197 A = 246 % (214 % at −40 °C) → clears within 200 %→5 s. 80 mA (not 62 mA) so the turn-on I²t is 19.1 % of melt I²t, under Littelfuse's ≤20 %/100 k-pulse limit. Normal ~5 mA ≪ 80 mA. 125 V/50 A interrupt, melt I²t 3.3e-4 A²s. Datasheet Littelfuse_451_453.pdf. |
