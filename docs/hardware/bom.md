...
> for WiFi — D25), U2 (R-78E12→R-78HB12), load switch (AO3401A→ZXMP6A13F→Si2309CDS→ finally **AQY212EH PhotoMOS SSR**, iter-48 F76; Q2/gate network removed), D1 (SS24→SS26), input bulk caps →100 V, sense divider
...
| D1        | **Vishay SS26-E3/52T** 60 V / 2 A Schottky            | **DO-214AA (SMB)** | 1   | PCB         | [SS26-E3/52T](https://www.digikey.com/en/products/result?keywords=SS26-E3%2F52T) | [78-SS26-E3/52T](https://www.mouser.com/c/?q=SS26-E3%2F52T) | $0.30  | Series reverse-polarity on 24 V input. 60 V (was SS24/40 V) to out-rate the ~53 V clamp (D19/DR-3). **Package SMA → SMB (API 2026-06-25).** |
...
| Ref       | Part                                            | Pkg     | Qty | Proto / PCB | DigiKey | Mouser | Price  | Notes |
|-----------|-------------------------------------------------|---------|-----|-------------|---------|--------|--------|-------|
| SSR1      | **Panasonic AQY212EH** PhotoMOS SSR (60 V / 550 mA, Ron 0.25 Ω) | DIP-4 (THT) | 1 | PCB | [search AQY212EH](https://www.digikey.com/en/products/result?keywords=AQY212EH) | [Mouser](https://www.mouser.com/c/?q=AQY212EH) | $2.81 | Display-feed load switch. **F76: replaced the discrete Q1 P-FET + Q2 BJT gate driver** (no discrete driver could be datasheet-guaranteed OFF at temp). OFF = open MOSFET, ≤1 µA leakage, opto-isolated, rated −40…+85 °C. DK 255-2963-ND Active. |
