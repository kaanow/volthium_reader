...
| R_inrush  | **150 Ω** 1206 **pulse-proof (Vishay CRCW-HP, 1.5 W)** — switched branch | 1206 | 1 | PCB | 541-150UTR-ND | 71-CRCW1206150RFKEAHP | $0.08 | **F80/F84:** limits recurring turn-on inrush into C3 to **~0.19 A** (below SSR 0.30 A@85 °C continuous → no one-shot reliance); survives the fault power to F2's clear (§8.1 short-term overload). Was 22 Ω (re-valued + pulse-rated, F84). Datasheet Vishay_CRCW_HP.pdf. |
