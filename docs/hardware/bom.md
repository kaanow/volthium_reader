...
| R_inrush  | **220 Ω** 1206 **pulse-proof (Vishay CRCW-HP, 1.5 W)** — switched branch | 1206 | 1 | PCB | 541-220UCT-ND | 71-CRCW1206220RFKEAHP | $0.40 | **F80/F84:** limits recurring turn-on inrush into C3 to **0.134 A** (below SSR 0.30 A@85 °C continuous → no one-shot reliance); survives the fault power to F2's clear (§8.1 short-term overload). Was 22 Ω (re-valued + pulse-rated, F84). Datasheet Vishay_CRCW_HP.pdf. |
| F2        | **62 mA** very-fast SMD fuse (Littelfuse 451 Nano2 SMF) — switched branch | 1206 | 1 | PCB | F3153TR-ND | 576-0451.062MRL | $4.57 | **NEW (F84):** coordinated fault clear. A V24_SW/C3/U2 short pulls only 0.134 A (R_inrush-limited) = 216 % → clears within the 200 %→5 s bound while the SSR (< continuous) and R_inrush (pulse-rated) survive; normal ~5 mA ≪ 62 mA. 125 V/50 A interrupt, melt I²t 1.9e-4 A²s. Datasheet Littelfuse_451_453.pdf. |
