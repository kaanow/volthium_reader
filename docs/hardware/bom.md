...
| R_hys     | UVLO external hysteresis (RESET→SENSE) | 0805 | 1 | PCB | — | — | $0.05 | **Reviewer F01/D33.** Sets a deliberate ~1.3 V band (trip ~20 V / release ~21.3 V) — the TPS3808G01's built-in VHYS (~6 mV at SENSE) is too small. Pairs with the R1≈4.87 MΩ/R2≈100 kΩ UVLO divider. |
...
| R_uv1,R_uv2 | UVLO pack divider → U4 SENSE (R1≈4.87 MΩ/R2≈100 kΩ, ~20 V trip)        | 0805 ×2 | 2 | PCB | [search](https://www.digikey.com/en/products/result?keywords=high+value+0805+resistor) | — | $0.10 | VIT 0.405 V → ~4.8 µA draw at 24 V (D28/D33). |
